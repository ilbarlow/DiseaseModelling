...
SAVETO = FEAT_FILE.parent.parent.parent / 'Figures' / 'paper_figures' / 'v1' / CANDIDATE_GENE
...
if __name__ == '__main__':
    ...
    if ANALYSIS_TYPE == 'all_stim':
        ...
        selected_features = ['relative_to_body_radial_velocity_head_tip_w_forward_10th_bluelight',
